...
import io.github.fruitcropxl.config.adapters.ConfigAdapter;
...
public class Config implements Serializable {
    ...
    /**
     * Gets the singleton instance of the simulation {@link io.github.fruitcropxl.config.Config}.
     * Creates a new Config if there was no existing instance.
     * <p>
     * Note: this is NOT thread safe.
     * 
     * @return Singleton instance of {@link io.github.fruitcropxl.config.Config}.
     */
