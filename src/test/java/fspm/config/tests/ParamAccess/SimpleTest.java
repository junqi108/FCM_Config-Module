...
public class SimpleTest {
        ...
        public void testAccessExamples() {
                ...
                CategoryStore store = CONFIG.getGroup("model.input.data.name",
                                DocumentCategoryNameGroup.class)
        ...
        public void testTypes() {
                CategoryStore store = CONFIG.getGroup("group",
                                DocumentCategoryNameGroup.class).getCategoryHierarchy()
        ...
        public void testCrossCategoryAccess() {
                CategoryStore store = CONFIG.getGroup("model.input.data.default", DocumentCategoryNameGroup.class)
                ...
                try {
                        Assert.assertEquals(0, store.getInteger("trainingSystem").intValue());
                        Assert.fail(
